...
export class DocumentService {
  ...
  updateMasterBySb(user, _id) {
    ...
    return this.http.post(`https://dm.uipep.com/v1/master/updateBySb`, {
      "_id": _id,
      "master": user
    }, httpOptions);
  }
  ...
  updateBoeByBoe(user, _id) {
    ...
    return this.http.post(`https://dm.uipep.com/v1/boe/updateByBoe`, {
      "_id": _id,
      "master": user
    }, httpOptions);
  }
  getBoeByBoe(boeNumber) {
    ...
    return this.http.post(`https://dm.uipep.com/v1/boe/getBoeByBoe`, {
      "boeNumber": boeNumber
    }, httpOptions);
  }
  ...
  public getPDF(data): Observable<any> {
    ...
    return this.http.post(`https://dm.uipep.com/v1/pdf/generate`, data, httpOptions)
      .map(res => res);
  }
