...
@Component({
  selector: 'edit-import-master-service-agreements',
  templateUrl: './import-master-service-agreements.component.html',
  styleUrls: ['./import-master-service-agreements.component.scss','../../commoncss/common.component.scss']
})
export class EditImportMasterServiceAgreementsComponent implements OnInit {
  publicUrl: any = '';
  UPLOAD_FORM: any = [];
  CURRENCY_LIST: any = [];
  BUYER_DETAILS: any = [];
      ...
      if (resp.data.length == 0) {
        this.documentService.addMasterService(e.value).subscribe(
          (res: any) => {
            ...
            this.userService
              .updateManyPipo(this.pipoArr, 'import', this.pipourl1, updatedData)
              .subscribe(
                (data) => {
                  console.log('king123');
                  console.log(data);
