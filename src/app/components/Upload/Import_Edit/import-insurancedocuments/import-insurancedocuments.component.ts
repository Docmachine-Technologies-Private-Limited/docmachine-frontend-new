...
@Component({
  selector: 'edit-import-insurancedocuments',
  templateUrl: './import-insurancedocuments.component.html',
  styleUrls: ['./import-insurancedocuments.component.scss','../../commoncss/common.component.scss']
})
export class EditImportInsurancedocumentsComponent implements OnInit {
  publicUrl: any = '';
  UPLOAD_FORM: any = [];
  CURRENCY_LIST: any = [];
  BUYER_DETAILS: any = [];
        ...
        this.documentService.addInsurance(e.value).subscribe(
          (res: any) => {
            ...
            this.userService.updateManyPipo(this.pipoArr, 'import', this.pipourl1, updatedData).subscribe(
              (data) => {
                console.log(data);
                this.router.navigate(['home/Summary/Import/Insurance-Document']);
              },
              (error) => {
                console.log('error');
              }
