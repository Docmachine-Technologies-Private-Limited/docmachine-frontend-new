...
@Component({
  selector: 'app-remittance-flow',
  templateUrl: './remittance-flow.component.html',
  styleUrls: ['./remittance-flow.component.scss']
})
export class RemittanceFlowComponent implements OnInit {
