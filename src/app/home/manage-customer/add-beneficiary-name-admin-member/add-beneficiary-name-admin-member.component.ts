...
@Component({
  selector: 'app-add-beneficiary-name-admin-member',
  templateUrl: './add-beneficiary-name-admin-member.component.html',
  styleUrls: ['./add-beneficiary-name-admin-member.component.scss']
})
export class AddBeneficiaryNameAdminMemberComponent implements OnInit {
  item2: any;
  loginForm: FormGroup;
  buyerForm: FormGroup;
  closeResult: string;
