...
@Component({
  ...
  templateUrl: './Import-New-Direct-Dispatch.component.html',
  styleUrls: ['./Import-New-Direct-Dispatch.component.scss'],

})
export class ImportNewDirectDispatchComponent implements OnInit {
  LocationData: any = []
  bankDetail: any = []
  commodity: any = []
  buyer: string;
  ...
  constructor(
    ...
    public BoeBillService: BoeBillService,
  ...
  getBill_Lodgments() {
    ...
    this.documentService.getBoe(1).subscribe((res: any) =>{
        console.log('uuuuuuuuuuuuuuuu',res)
    })
    this.BoeBillService.getBoeBillList().then((res: any) => {
      this.BoeBillService.Boebills$.subscribe((data: any) => {
        console.log('getBoeBillList', data)
           for (let index = 0; index < data.length; index++) {
          ...
          this.item1.forEach((element, i) => {
            this.buyerName[i] = element.boeName;
          });
          for (let index = 0; index < data.length; index++) {
