...
@Component({
  selector: 'app-import-swift-copy-document-summary',
  templateUrl: './import-swift-copy-document-summary.component.html',
  styleUrls: ['./import-swift-copy-document-summary.component.scss']
})
export class ImportSwiftCopyDocumentSummaryComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    await this.filteranytablepagination.LoadTableImport({}, { skip: 0, limit: 10 }, 'SwiftCopyDocuments',this.FILTER_VALUE_LIST_NEW)?.SwiftCopyDocuments().then((res) => {
 ...
 async onSubmit(value: any) {
    ...
    await this.filteranytablepagination.LoadTableImport(this.FILTER_FORM_VALUE, { skip: 0, limit: 10 }, 'SwiftCopyDocuments',this.FILTER_VALUE_LIST_NEW)?.SwiftCopyDocuments().then((res) => {
      this.FILTER_VALUE_LIST_NEW = res;
    });
  }
