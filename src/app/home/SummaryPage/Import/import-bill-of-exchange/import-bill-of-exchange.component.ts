...
@Component({
  ...
  templateUrl: './import-bill-of-exchange.component.html',
  styleUrls: ['./import-bill-of-exchange.component.scss']
})
...
export class ImportBillOfExchangeComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    await this.filteranytablepagination.LoadTableImport({}, { skip: 0, limit: 10 }, 'billofexchanges',this.FILTER_VALUE_LIST_NEW)?.billofexchanges().then((res) => {
