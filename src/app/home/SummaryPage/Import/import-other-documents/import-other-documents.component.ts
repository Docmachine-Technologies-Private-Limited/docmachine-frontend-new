...
@Component({
  ...
  templateUrl: './import-other-documents.component.html',
...
export class ImportOtherDocumentsComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    await this.filteranytablepagination.LoadTableImport({}, { skip: 0, limit: 10 }, 'packinglists',this.FILTER_VALUE_LIST_NEW)?.packinglists().then((res) => {
