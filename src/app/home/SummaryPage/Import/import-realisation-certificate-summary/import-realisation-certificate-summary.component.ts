...
@Component({
  selector: 'app-import-realisation-certificate-summary',
  templateUrl: './import-realisation-certificate-summary.component.html',
  styleUrls: ['./import-realisation-certificate-summary.component.scss']
})
export class ImportRealisationCertificateSummaryComponent implements OnInit {
