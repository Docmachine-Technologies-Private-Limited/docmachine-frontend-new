  ...
  onSubmitblCopy(e){
    ...
    this.documentService.addAirwayBlcopyFile(e.form.value).subscribe(
      (res) => {
        ...
        this.userService.updateManyPipo(this.pipoArr, "airwayBlcopy",this.pipourl1)
            .subscribe(
              data => {
                //this.pipoData[`${this.pipoDoc}`] = args[1].data
                console.log("king123")
   ...
   onSubmitCommercial(e){
    ...
    this.documentService.addCommercial(e.form.value).subscribe(
      (res) => {
        ...
        this.userService.updateManyPipo(this.pipoArr, "commercial",this.pipourl1)
            .subscribe(
              data => {
                //this.pipoData[`${this.pipoDoc}`] = args[1].data
                console.log("king123")
  ...
  onSubmitBillExchange(e){
    ...
    this.documentService.addBillExchange(e.form.value).subscribe(
      (res) => {
        ...
        this.userService.updateManyPipo(this.pipoArr, "billOfExchange",this.pipourl1)
            .subscribe(
              data => {
                //this.pipoData[`${this.pipoDoc}`] = args[1].data
                console.log("king123")
  ...
  onSubmitDestruction(e){
    ...
    this.documentService.addDestruction(e.form.value).subscribe(
      (res) => {
        ...
        this.userService.updateManyPipo(this.pipoArr, "destruction",this.pipourl1)
            .subscribe(
              data => {
                //this.pipoData[`${this.pipoDoc}`] = args[1].data
                console.log("king123")
  ...
  onSubmitPackingList(e){
    ...
    this.documentService.addPackingList(e.form.value).subscribe(
      (res) => {
        ...
        this.userService.updateManyPipo(this.pipoArr, "packingList",this.pipourl1)
            .subscribe(
              data => {
                //this.pipoData[`${this.pipoDoc}`] = args[1].data
                console.log("king123")
