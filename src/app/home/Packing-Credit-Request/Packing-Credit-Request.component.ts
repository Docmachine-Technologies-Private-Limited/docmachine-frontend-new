...
export class PackingCreditRequestComponent implements OnInit {
  ...
  setBank(key: any, bank: any) {
    this.SET_CREDIT_DEBIT_LIST[key] = bank;
  ...
  PREVIEWS_URL(className:any) {
    ...
    pdfDocGenerator.getBuffer((buffer)=> {
      console.log('--> example.pdf',buffer,this.bufferToBase64(buffer))
      this.PREVIEWS_URL_LIST.push(this.bufferToBase64(buffer));
    });
  }
  toArrayBuffer(myBuf) {
