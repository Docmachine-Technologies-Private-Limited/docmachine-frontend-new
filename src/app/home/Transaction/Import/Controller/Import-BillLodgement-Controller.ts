...
export class ImportBillLodgementControllerData {
    COMPANY_INFO: any = {};
        ...
        return {
            Fedral: async (validator, BENEFICIARY_DETAILS, filldata, ToForwardContract_Selected) => {
                return new Promise(async (resolve, reject) => {
                    ...
                    let formUrl = './../../../assets/pdf/FedralBank/ImportBillLodgement.pdf'
                    ...
                    getAllFields[7]?.setText(validator.COMPANY_INFO[0]?.teamName + '\n' + validator.COMPANY_INFO[0]?.adress);
