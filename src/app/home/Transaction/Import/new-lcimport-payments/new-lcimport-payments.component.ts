...
@Component({
  selector: 'app-new-lcimport-payments',
  templateUrl: './new-lcimport-payments.component.html',
  styleUrls: ['./new-lcimport-payments.component.scss','../../commoncss/common.component.scss']
})
export class NewLCImportPaymentsComponent implements OnInit {
  @Input('data') data: any = [];
  ...
  BENEFICIARY_CALLBACK(value: any) {
    ...
    this.documentService.filterAnyTable({
      ...
      "paymentTerm.type": { value: "Letter of Credit" }
