...
import { BOEORMMactchData } from './BOE-ORM-Mactch-data';

@Component({
  selector: 'app-BOE_ORMmatch-off',
  templateUrl: './BOE_ORMmatch-off.component.html',
  styleUrls: ['./BOE_ORMmatch-off.component.scss', '../../commoncss/common.component.scss']
})
export class BOE_ORMMMatchOffComponent implements OnInit {
  @Input('data') data: any = [];
  ...
  constructor(public sanitizer: DomSanitizer,
    ...
    public exportbilllodgementdata: BOEORMMactchData,
