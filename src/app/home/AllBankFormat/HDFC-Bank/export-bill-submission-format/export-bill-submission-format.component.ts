...
@Component({
  selector: 'hdfc-bank-bill-submission-format',
  templateUrl: './export-bill-submission-format.component.html',
  styleUrls: ['./export-bill-submission-format.component.scss']
})
export class hdfcbankBillSubmissionFormatComponent implements OnInit, OnChanges {
  @Input('data') data: any = [];
