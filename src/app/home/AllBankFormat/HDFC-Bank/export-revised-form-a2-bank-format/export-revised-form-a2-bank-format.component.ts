...
@Component({
  selector: 'hdfc-bank-revised-form-a2-bank-format',
  templateUrl: './export-revised-form-a2-bank-format.component.html',
  styleUrls: ['./export-revised-form-a2-bank-format.component.scss']
})
export class hdfcbankRevisedFormA2BANKFormatComponent implements OnInit, OnChanges {
  @Input('data') data: any = [];
